...
<div class="theme-page" style="height: 100vh;padding-bottom:22%">
	...
	<div class="addgateway">
		<p class="text-center" style="font-size: 14px;margin-bottom:8px;">Add gateways</p>
		<div class="d-flex justify-content-center" style="gap:16px">
			<Button size="md" on:click={searchGateways} style="width:auto;height:40px;">
	...
	<div class="scroll">
		...
		<Modal bind:isOpen={fullnetscan} title="IP address" style="height:50vh;">
			<div class="my-2">
				<Inputfield placeholder="Enter ip" style="display:flex;justify-content:center;" />
			</div>
		</Modal>
		...
		{#if !searching}
			...
			{:else}
				...
				>
					<img src="/images/noGateways.png" alt="no gateways found" style="margin-top: 50px;" />
					No gateways found
				</div>
			{/each}
		{:else}
	...
	<Button outlined class="back" on:click={() => goto('/search')}>
