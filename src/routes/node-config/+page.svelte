<script lang="ts">
	...
	onMount(() => {
		...
		pluginCategories = Object.entries(store).map(([name, data]) => ({
			name,
...
<div class="theme-page">
	<div class="header bottom-shadow">
		<p class="title-large" style="padding-left: 8px;">Plugins</p>
	</div>
	<div class="content">
	...
	<AvailableCategories bind:isOpen title="Plugin Categories" />
</div>
